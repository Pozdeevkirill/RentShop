...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoRentShop.Models.ScopeContexts.OrderToItemScopeContext", b =>
                {
                    ...
                    b.HasIndex("EntitToId");

                    b.HasIndex("EntityId");

                    b.ToTable("OrderToItemScopeContext");
                });
            ...
            modelBuilder.Entity("VideoRentShop.Models.Shop.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ItemOrder", b =>
                {
                    ...
                    b.HasOne("VideoRentShop.Models.Shop.Order", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VideoRentShop.Models.ScopeContexts.OrderToItemScopeContext", b =>
                {
                    b.HasOne("VideoRentShop.Models.Shop.Item", "EntitTo")
                        .WithMany()
                        .HasForeignKey("EntitToId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VideoRentShop.Models.Shop.Order", "Entity")
                        .WithMany()
