...
namespace VideoRentShop.Services.Implementation.Identity
{
    public class TokenService : ITokenService
    {
        ...
        {
            var principial = GetPrincipalFromExpiredToken(request.AccessToken);
            var username = principial.Identity.Name;

            ///TODO: Добавить проверку на существование юзера

            var newToken = GenerateAccessToken(principial.Claims);
